...
var Test1Controller = (function () {
    ...
    _createClass(Test1Controller, {
        ...
        configRouter: {
            value: function configRouter($router) {
                $router.config([{
                    path: "/route1",
                    component: "route1"
                }, {
